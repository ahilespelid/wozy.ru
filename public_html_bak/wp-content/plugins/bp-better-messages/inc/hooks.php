...
if ( !class_exists( 'BP_Better_Messages_Hooks' ) ):
    ...
    class BP_Better_Messages_Hooks
    {
        ...
        public function leave_thread_button( $thread_id, $participants, $is_mini ){
            if( count($participants['recipients']) < 2 ) return false;
        ...
        public function css_customizations(){
            ...
            if( ! empty( BP_Better_Messages()->settings['miniWindowsHeight'] ) && BP_Better_Messages()->settings['miniWindowsHeight'] !== 426 ){
                ...
                $rules[] = '.bp-messages-wrap.bp-better-messages-list .messages.no-new-thread-button .scroller{max-height:' . $css_2 . 'px!important;}';
            ...
            if( ! empty( BP_Better_Messages()->settings['miniChatsHeight'] ) && BP_Better_Messages()->settings['miniChatsHeight'] !== 426 ) {
                ...
                $css_3   = 300 + $change;
                $rules[] = '.bp-messages-wrap.bp-better-messages-mini .scroller{max-height:' . $css_3 . 'px!important;}';
            }
        ...
        public function inbox_counter_javascript(){
            ...
            $js = ob_get_clean();
            if( trim( $js ) !== '' ){
                echo BP_Better_Messages()->functions->minify_js( $js );
            }
        }
